...
%s
*constraints2r
^Time (s): cpu = 00:00:00 ; elapsed = 00:00:00.102 . Memory (MB): peak = 709.352 ; gain = 0.0002default:default
ƒ

Phase %s%s
101*constraints2
...
%s
*constraints2r
^Time (s): cpu = 00:00:00 ; elapsed = 00:00:00.112 . Memory (MB): peak = 709.352 ; gain = 0.0002default:default
k

Phase %s%s
101*constraints2
...
%s
*constraints2r
^Time (s): cpu = 00:00:00 ; elapsed = 00:00:00.113 . Memory (MB): peak = 709.352 ; gain = 0.0002default:default
h

Phase %s%s
101*constraints2
...
;
/Phase 1.1.4 Build Macros | Checksum: 23992cd38
*common
‰

%s
*constraints2r
^Time (s): cpu = 00:00:00 ; elapsed = 00:00:00.442 . Memory (MB): peak = 709.352 ; gain = 0.0002default:default
|

Phase %s%s
101*constraints2
...
O
CPhase 1.1.5 Implementation Feasibility check | Checksum: 23992cd38
*common
‰

%s
*constraints2r
^Time (s): cpu = 00:00:00 ; elapsed = 00:00:00.624 . Memory (MB): peak = 709.352 ; gain = 0.0002default:default
k

Phase %s%s
101*constraints2
...
>
2Phase 1.1.6 Pre-Place Cells | Checksum: 23992cd38
*common
‰

%s
*constraints2r
^Time (s): cpu = 00:00:00 ; elapsed = 00:00:00.632 . Memory (MB): peak = 709.352 ; gain = 0.0002default:default
Ž

Phase %s%s
101*constraints2
...
a
UPhase 1.1.7 IO Placement/ Clock Placement/ Build Placer Device | Checksum: 158193afa
*common
…

%s
*constraints2n
ZTime (s): cpu = 00:00:01 ; elapsed = 00:00:02 . Memory (MB): peak = 709.352 ; gain = 0.0002default:default
v

Phase %s%s
101*constraints2
...
C
7Phase 1.1.8.1.1 Build Clock Data | Checksum: 18d816c99
*common
…

%s
*constraints2n
ZTime (s): cpu = 00:00:02 ; elapsed = 00:00:02 . Memory (MB): peak = 710.574 ; gain = 1.2232default:default
B
6Phase 1.1.8.1 Place Init Design | Checksum: 17546efb9
*common
…

%s
*constraints2n
ZTime (s): cpu = 00:00:02 ; elapsed = 00:00:03 . Memory (MB): peak = 710.574 ; gain = 1.2232default:default
I
=Phase 1.1.8 Build Placer Netlist Model | Checksum: 17546efb9
*common
…

%s
...
Q
EPhase 1.1.9.1 Constrain Global/Regional Clocks | Checksum: 17546efb9
*common
…

%s
...
ZTime (s): cpu = 00:00:02 ; elapsed = 00:00:03 . Memory (MB): peak = 710.574 ; gain = 1.2232default:default
F
:Phase 1.1.9 Constrain Clocks/Macros | Checksum: 17546efb9
*common
…

%s
...
ZTime (s): cpu = 00:00:02 ; elapsed = 00:00:03 . Memory (MB): peak = 710.574 ; gain = 1.2232default:default
G
;Phase 1.1 Placer Initialization Core | Checksum: 17546efb9
*common
…

%s
...
ZTime (s): cpu = 00:00:02 ; elapsed = 00:00:03 . Memory (MB): peak = 710.574 ; gain = 1.2232default:default
@
4Phase 1 Placer Initialization | Checksum: 17546efb9
*common
…

%s
...
;
/Phase 2 Global Placement | Checksum: 27811ab57
*common
†

%s
*constraints2o
[Time (s): cpu = 00:00:08 ; elapsed = 00:00:07 . Memory (MB): peak = 723.469 ; gain = 14.1172default:default
h

Phase %s%s
101*constraints2
...
G
;Phase 3.1 Commit Multi Column Macros | Checksum: 27811ab57
*common
†

%s
*constraints2o
[Time (s): cpu = 00:00:09 ; elapsed = 00:00:07 . Memory (MB): peak = 723.469 ; gain = 14.1172default:default
v

Phase %s%s
101*constraints2
...
I
=Phase 3.2 Commit Most Macros & LUTRAMs | Checksum: 20ba4bafa
*common
†

%s
*constraints2o
[Time (s): cpu = 00:00:09 ; elapsed = 00:00:08 . Memory (MB): peak = 728.672 ; gain = 19.3202default:default
p

Phase %s%s
101*constraints2
...
C
7Phase 3.3 Area Swap Optimization | Checksum: 2c7c5b02a
*common
†

%s
...
B
6Phase 3.4 Timing Path Optimizer | Checksum: 24945d999
*common
†

%s
*constraints2o
[Time (s): cpu = 00:00:10 ; elapsed = 00:00:08 . Memory (MB): peak = 729.430 ; gain = 20.0782default:default
z

Phase %s%s
101*constraints2
...
M
APhase 3.5 Commit Small Macros & Core Logic | Checksum: 262fa39bc
*common
†

%s
*constraints2o
[Time (s): cpu = 00:00:10 ; elapsed = 00:00:09 . Memory (MB): peak = 730.430 ; gain = 21.0782default:default
l

Phase %s%s
101*constraints2
...
?
3Phase 3.6 Re-assign LUT pins | Checksum: 262fa39bc
*common
†

%s
...
[Time (s): cpu = 00:00:10 ; elapsed = 00:00:09 . Memory (MB): peak = 730.430 ; gain = 21.0782default:default
;
/Phase 3 Detail Placement | Checksum: 262fa39bc
*common
†

%s
...
@
4Phase 4.1 PCOPT Shape updates | Checksum: 29ac2864e
*common
†

%s
...
Q
EPhase 4.2.1 Post Placement Timing Optimization | Checksum: 22ffcec53
*common
†

%s
*constraints2o
[Time (s): cpu = 00:00:11 ; elapsed = 00:00:09 . Memory (MB): peak = 730.430 ; gain = 21.0782default:default
H
<Phase 4.2 Post Placement Optimization | Checksum: 22ffcec53
*common
†

%s
...
C
7Phase 4.3 Post Placement Cleanup | Checksum: 22ffcec53
*common
†

%s
...
C
7Phase 4.4.1 Congestion Reporting | Checksum: 22ffcec53
*common
†

%s
...
A
5Phase 4.4.2 updateTiming final | Checksum: 2bbda97c3
*common
†

%s
*constraints2o
[Time (s): cpu = 00:00:12 ; elapsed = 00:00:10 . Memory (MB): peak = 731.250 ; gain = 21.8982default:default
p

Phase %s%s
101*constraints2
...
C
7Phase 4.4.3 Dump Critical Paths  | Checksum: 2bbda97c3
*common
†

%s
...
:
.Phase 4.4.4 Restore STA | Checksum: 2bbda97c3
*common
†

%s
...
>
2Phase 4.4.5 Print Final WNS | Checksum: 2bbda97c3
*common
†

%s
...
[Time (s): cpu = 00:00:12 ; elapsed = 00:00:10 . Memory (MB): peak = 731.250 ; gain = 21.8982default:default
=
1Phase 4.4 Placer Reporting | Checksum: 2bbda97c3
*common
†

%s
...
D
8Phase 4.5 Final Placement Cleanup | Checksum: 2631e5237
*common
†

%s
...
[Time (s): cpu = 00:00:12 ; elapsed = 00:00:10 . Memory (MB): peak = 731.250 ; gain = 21.8982default:default
S
GPhase 4 Post Placement Optimization and Clean-Up | Checksum: 2631e5237
*common
†

%s
...
[Time (s): cpu = 00:00:12 ; elapsed = 00:00:10 . Memory (MB): peak = 731.250 ; gain = 21.8982default:default
5
)Ending Placer Task | Checksum: 177572c4d
*common
†

%s
*constraints2o
[Time (s): cpu = 00:00:00 ; elapsed = 00:00:10 . Memory (MB): peak = 731.250 ; gain = 21.8982default:default
Q
Releasing license: %s
83*common2"
...
731.2502default:default2
23.5272default:defaultZ17-268
^
...

sreport_utilization: Time (s): cpu = 00:00:00 ; elapsed = 00:00:00.070 . Memory (MB): peak = 735.516 ; gain = 0.000
*common
j
...
00:00:002default:default2 
00:00:00.3682default:default2
735.5162default:default2
0.0002default:defaultZ17-268

